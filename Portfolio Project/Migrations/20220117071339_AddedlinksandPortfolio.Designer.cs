...
namespace Portfolio_Project.Migrations
{
    ...
    [Migration("20220117071339_AddedlinksandPortfolio")]
    partial class AddedlinksandPortfolio
    {
            ...
            modelBuilder.Entity("Portfolio_Project.Models.Projects", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProjectID = 3,
                            About = "<p>Nicholasnewton.net is a personal portfolio project that is used to display my best work as well as introduce me to whoever comes across the site.</p>",
                            GithubLink = "https://github.com/nicknewton100/Portfolio",
                            Name = "Portfolio",
                            ShortDesc = "<p>nichoasnewton.net is a personal portfolio website used to showscase my skills/projects</p>",
                            ...
                            ThumbnailPath = "/images/PortfolioHome.jpg",
                            WebLink = "www.nicholasnewton.net"
                        });
                });
